...
const dateElement = document.querySelector(".weather")
...
function getWeatherByCoordinates(latitude, longitude) {
  getCityWeather(
    `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&APPID=35b1f1d45a7b4378cf2430ae601816be&units=metric`
  )
}
function getForecastByCoordinates(latitude, longitude) {
  getForecast(
    `https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&lon=${longitude}&APPID=35b1f1d45a7b4378cf2430ae601816be&units=metric`
  )
}
